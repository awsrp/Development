...
const AppServer = () =>{
    return(        
       ...
       <div className="row" >
           ...
           <div className="row" style={{marginTop:'60px'}}>            
            ...
            <table>
            <tr>
                <td><h1>1. Please select type of application hosted environment </h1></td>
            </tr>
            <tr>
                <td>
 ...
                    <option value="option 2">Linux</option>
            ...
            <hr/>
                <tr>
                    <td>
                    <h1>2. What is your current appserver cluster strength:</h1>
                    <select name="selectList" id="selectList" style={{height: '28px', marginTop:'10px;'}}>
 ...
                    <option value="option 2">4-8</option>
                ...
                <tr>
                    <td>
                    <h1>3. How many Web servers are present in your current On-prem Env</h1>
                    <select name="selectList" id="selectList" style={{height: '28px', marginTop:'10px;'}}>
                    <option value="option 1">2-4</option>
                    <option value="option 2"> 4-8</option>
                    <option value="option 1">8to12</option>
                    <option value="option 1">above 12</option>
                    </select>
                    </td>
                </tr>
                <hr/>
